    ...
    <aside className="hidden lg:flex fixed inset-y-0 left-0 z-40 w-72 flex-col border-r border-line bg-surface">
      ...
      <div className="border-t border-line p-4">
        <div className="flex items-center gap-3 rounded-xl bg-surface-muted p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-primary text-sm font-semibold text-white shrink-0">
          ...
          <button
            ...
            aria-label="Log out"
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-ink-secondary hover:bg-white hover:text-danger-500 transition-colors"
          >
